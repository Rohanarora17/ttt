  ...
  return (
    <div className="profile">
      <div className="profile_details">
        ...
        {/* BG Image Part */}
        <div className="bg">
          <img src={require("../../assets/river_bg.jpg")} alt="Background" />
        </div>
          ...
          <div className="first">
            ...
            <div className="profile_name">
              <div className="p_name">
                Anuj Gosalia
                <img src={require("../../assets/diamond.png")} alt="diamond" />
          ...
          <div className="second">
            ...
            <div className="stats">
              <div className="allicon">
                ...
                <div className="icons">
                  <img src={require("../../assets/yello like ucon.jpg")} alt="like" />
                  12
                </div>
                <div className="icons">
                  <img src={require("../../assets/vision.png")} alt="views" />
                  57.8k
                </div>
                <div className="icons">
                  <img src={require("../../assets/like.png")} alt="heart" />
                  26.0k
                </div>
              </div>
            </div>
      ...
      <div className="last">
        ...
        <div className="content">
          ...
          <div className="dec">
            The world is changing at the feverish pace. Friend, colleagues and
        ...
        <div className="content">
          ...
          <div className="dec">
            Think about it - this cricket series wad akin to therapy. Laying our
            childhood trauma up top, working with it slowly and surely over two
            m...
          </div>
